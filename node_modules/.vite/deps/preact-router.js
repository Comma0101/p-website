...
function s(n, t, r) {
  ...
  for (var h3 = Math.max(n.length, t.length), v2 = 0; v2 < h3; v2++) if (t[v2] && ":" === t[v2].charAt(0)) {
...
c(D.prototype = new k(), { shouldComponentUpdate: function(n) {
  ...
  var e, u, f = n.onChange, a2 = t.url, s2 = this.c, h3 = this.g(H(n.children), a2);
  ...
  return _(k2.Provider, { value: s2 }, u);
} });
var E2 = function(n) {
